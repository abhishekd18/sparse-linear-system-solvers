...
\"./Output/Error_GMRES.out\" u 1:3 w l axes x1y1 lt 1 lc rgb \"red\" title \"Relative Residual\"">gnuplot.gp
gnuplot gnuplot.gp
...
set grid x y
plot \"./Output/Error_GMRES.out\" u 1:2 w l axes x1y2 lt 1 lc rgb \"green\" title \"Error ||x* - xm||\",\
\"./Output/Error_GMRES.out\" u 1:3 w l axes x1y1 lt 1 lc rgb \"red\" title \"Absolute Residual\"">gnuplot.gp
gnuplot gnuplot.gp
ps2pdf -dEPSCrop -dNOSAFER ./Output/GMRES_RESTARTED_NO.ps ./Output/GMRES_RESTARTED_NO.pdf
mv ./Output/Error_GMRES.out ./Output/Error_GMRES_RESTARTED_NO.out
...
mv ./Output/Error_GMRES.out ./Output/Error_GMRES_RESTARTED_JACOBI.out
...
mv ./Output/Error_GMRES.out ./Output/Error_GMRES_RESTARTED_GAUSS_SEIDEL.out
...
set log y2
set grid x y
plot \"./Output/Error_CG_Anorm.out\" u 1:2 w l axes x1y2 lw 2 lt 1 lc rgb \"green\" title \"Error in A norm\",\
\"./Output/Error_CG.out\" u 1:2 w l axes x1y2 lw 2 lt 1 lc rgb \"blue\" title \"Error in 2 norm\",\
\"./Output/Error_CG.out\" u 1:3 w l axes x1y1 lw 0.1 lt 1 lc rgb \"red\" title \"Relative Residual\"">gnuplot.gp
gnuplot gnuplot.gp
